...
/*     */ 
/*     */ public class TileRelay extends TileEE
/*     */   implements ISpecialInventory, ISidedInventory, IEEPowerNet
/*     */ {
/*  19 */   private ItemStack[] items = new ItemStack[8];
...
/*     */     {
/* 823 */       var1.openGui(mod_EE.getInstance(), GuiIds.RELAY_1, this.world, this.x, this.y, this.z);
/*     */     }
/*     */ 
/* 826 */     return true;
/*     */   }
...
/*     */   {
/* 844 */     return var1 == 3 ? EEBase.relayFront : var1 == 1 ? EEBase.relayTop : EEBase.relaySide;
/*     */   }
/*     */ 
