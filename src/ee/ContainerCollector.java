...
/*     */   {
/*  24 */     setPlayer(var1.player);
/*  25 */     this.collector = var2;
/*  26 */     a(new Slot(var2, 0, 124, 58));
/*     */ 
/*  30 */     for (int var3 = 0; var3 <= 1; var3++)
/*     */     {
/*  32 */       for (int var4 = 0; var4 <= 3; var4++)
/*     */       {
/*  34 */         a(new Slot(var2, var4 * 2 + var3 + 1, 20 + var3 * 18, 8 + var4 * 18));
/*     */       }
/*     */     }
/*     */ 
/*  38 */     a(new Slot(var2, 9, 124, 13));
/*  39 */     a(new Slot(var2, 10, 153, 36));
/*     */ 
/*  41 */     for (var3 = 0; var3 < 3; var3++)
/*     */     {
/*  43 */       for (int var4 = 0; var4 < 9; var4++)
/*     */       {
/*  45 */         a(new Slot(var1, var4 + var3 * 9 + 9, 8 + var4 * 18, 84 + var3 * 18));
/*     */       }
/*     */     }
/*     */ 
/*  49 */     for (var3 = 0; var3 < 9; var3++)
/*     */     {
/*  51 */       a(new Slot(var1, var3, 8 + var3 * 18, 142));
/*     */     }
/*     */   }
/*     */ 
...
/*     */         }
/*     */       }
/* 161 */       else if ((var1 >= 11) && (var1 < 38))
/*     */       {
/* 163 */         if (EEMaps.isFuel(var4))
/*     */         {
/* 165 */           if (!a(var4, 0, 8, true))
/*     */           {
/* 167 */             if (var4.count == 0)
/*     */             {
/* 169 */               var3.set(null);
...
/*     */           }
/*     */         }
/* 175 */         else if (!a(var4, 38, 46, false))
/*     */         {
/* 177 */           if (var4.count == 0)
/*     */           {
/* 179 */             var3.set(null);
...
/*     */         }
/*     */       }
/* 185 */       else if ((var1 >= 38) && (var1 <= 46))
/*     */       {
/* 187 */         if ((EEMaps.isFuel(var4)) && (!a(var4, 0, 8, true)))
/*     */         {
/* 189 */           if (var4.count == 0)
/*     */           {
/* 191 */             var3.set(null);
...
/*     */         }
/*     */       }
/* 197 */       else if (!a(var4, 11, 46, false))
/*     */       {
/* 199 */         if (var4.count == 0)
/*     */         {
/* 201 */           var3.set(null);
 ...
 * Qualified Name:     ee.ContainerCollector
