...
/*      */   {
/*   26 */     this.items = new ItemStack[19];
...
/*      */     {
/*   43 */       ItemStack itemstack = getItem(i);
/*      */ 
/*   45 */       if (itemstack != null)
/*      */       {
/*   50 */         float f = this.world.random.nextFloat() * 0.8F + 0.1F;
/*   51 */         float f1 = this.world.random.nextFloat() * 0.8F + 0.1F;
/*   52 */         float f2 = this.world.random.nextFloat() * 0.8F + 0.1F;
/*      */ 
/*   60 */         while (itemstack.count > 0)
/*      */         {
/*   65 */           int j = this.world.random.nextInt(21) + 10;
/*      */ 
/*   67 */           if (j > itemstack.count)
/*      */           {
/*   69 */             j = itemstack.count;
/*      */           }
/*      */ 
/*   72 */           itemstack.count -= j;
/*   73 */           EntityItem entityitem = new EntityItem(this.world, this.x + f, this.y + f1, this.z + f2, new ItemStack(itemstack.id, j, itemstack.getData()));
/*      */ 
/*   75 */           if (entityitem != null)
/*      */           {
/*   77 */             float f3 = 0.05F;
/*   78 */             entityitem.motX = ((float)this.world.random.nextGaussian() * f3);
/*   79 */             entityitem.motY = ((float)this.world.random.nextGaussian() * f3 + 0.2F);
/*   80 */             entityitem.motZ = ((float)this.world.random.nextGaussian() * f3);
/*      */ 
/*   82 */             if ((entityitem.itemStack.getItem() instanceof ItemKleinStar))
/*      */             {
/*   84 */               ((ItemKleinStar)entityitem.itemStack.getItem()).setKleinPoints(entityitem.itemStack, ((ItemKleinStar)itemstack.getItem()).getKleinPoints(itemstack));
/*      */             }
/*      */ 
/*   87 */             this.world.addEntity(entityitem);
/*      */           }
/*      */         }
/*      */       }
/*      */     }
...
/*  500 */     if (j == 0)
/*      */     {
/*  502 */       if (this.collectorSunTime <= 4800000 - i)
/*      */       {
...
/*      */   {
/*  655 */     return this.collectorSunTime * i / 4800000;
/*      */   }
/*      */ 
...
/*      */   {
/*  677 */     return getRealSunStatus() * 10;
/*      */   }
/*      */ 
/*      */   public boolean isUsingPower()
/*      */   {
...
/*      */   {
/* 1081 */     if (!this.world.isStatic)
/*      */     {
/* 1083 */       entityhuman.openGui(mod_EE.getInstance(), GuiIds.COLLECTOR_3, this.world, this.x, this.y, this.z);
/*      */     }
/*      */ 
/* 1086 */     return true;
/*      */   }
...
/* 1091 */     if (i == 1)
/*      */     {
/* 1093 */       return EEBase.collector3Top;
/*      */     }
/*      */ 
/* 1096 */     byte byte0 = this.direction;
/*      */ 
/* 1098 */     if (i != byte0)
/*      */     {
/* 1100 */       return EEBase.collectorSide;
/*      */     }
/*      */ 
/* 1104 */     return EEBase.collectorFront;
/*      */   }
/*      */ 
...
/* 1110 */     if (i == 1)
/*      */     {
/* 1112 */       return EEBase.collector3Top;
/*      */     }
/*      */ 
/* 1115 */     if (i == 3)
/*      */     {
/* 1117 */       return EEBase.collectorFront;
/*      */     }
/*      */ 
/* 1121 */     return EEBase.collectorSide;
/*      */   }
/*      */ 
 ...
 * Qualified Name:     ee.TileCollector3
