...
/*  28 */     a(new Slot(var2, 0, 84, 44));
/*     */ 
/*  32 */     for (int var3 = 0; var3 <= 2; var3++)
/*     */     {
/*  34 */       for (int var4 = 0; var4 <= 3; var4++)
/*     */       {
/*  36 */         a(new Slot(var2, var3 * 4 + var4 + 1, 26 + var3 * 18, 18 + var4 * 18));
/*     */       }
/*     */     }
/*     */ 
/*  40 */     a(new Slot(var2, 13, 144, 44));
/*     */ 
/*  42 */     for (int var3 = 0; var3 < 3; var3++)
/*     */     {
/*  44 */       for (int var4 = 0; var4 < 9; var4++)
/*     */       {
/*  46 */         a(new Slot(var1, var4 + var3 * 9 + 9, 16 + var4 * 18, 101 + var3 * 18));
/*     */       }
/*     */     }
/*     */ 
/*  50 */     for (int var3 = 0; var3 < 9; var3++)
/*     */     {
/*  52 */       a(new Slot(var1, var3, 16 + var3 * 18, 159));
/*     */     }
/*     */   }
/*     */ 
...
/*     */         }
/*     */       }
/* 175 */       else if ((var1 >= 14) && (var1 <= 40))
/*     */       {
/* 177 */         if (EEMaps.getEMC(var4.id) > 0)
/*     */         {
/* 179 */           if (!a(var4, 0, 13, true))
/*     */           {
/* 181 */             if (var4.count == 0)
/*     */             {
/* 183 */               var3.set(null);
...
/*     */           }
/*     */         }
/* 189 */         else if (!a(var4, 41, 49, false))
/*     */         {
/* 191 */           if (var4.count == 0)
/*     */           {
/* 193 */             var3.set(null);
...
/*     */         }
/*     */       }
/* 199 */       else if ((var1 >= 41) && (var1 <= 49))
/*     */       {
/* 201 */         if (EEMaps.getEMC(var4.id) > 0)
/*     */         {
/* 203 */           if (!a(var4, 0, 13, true))
/*     */           {
/* 205 */             if (var4.count == 0)
/*     */             {
/* 207 */               var3.set(null);
...
/*     */           }
/*     */         }
/* 213 */         else if (!a(var4, 14, 40, false))
/*     */         {
/* 215 */           if (var4.count == 0)
/*     */           {
/* 217 */             var3.set(null);
...
/*     */         }
/*     */       }
/* 223 */       else if (!a(var4, 14, 49, false))
/*     */       {
/* 225 */         if (var4.count == 0)
/*     */         {
/* 227 */           var3.set(null);
 ...
 * Qualified Name:     ee.ContainerRelay2
