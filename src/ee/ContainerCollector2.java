...
/*     */ 
/*     */ public class ContainerCollector2 extends Container
/*     */ {
/*     */   private TileCollector2 collector;
...
/*     */ 
/*     */   public ContainerCollector2(PlayerInventory var1, TileCollector2 var2)
/*     */   {
/*  24 */     this.collector = var2;
/*  25 */     setPlayer(var1.player);
/*  26 */     a(new Slot(var2, 0, 140, 58));
/*     */ 
/*  30 */     for (int var3 = 0; var3 <= 2; var3++)
/*     */     {
...
/*     */       {
/*  45 */         a(new Slot(var1, var4 + var3 * 9 + 9, 20 + var4 * 18, 84 + var3 * 18));
/*     */       }
/*     */     }
/*     */ 
...
/*     */         }
/*     */       }
/* 161 */       else if ((var1 >= 15) && (var1 < 42))
/*     */       {
/* 163 */         if (EEMaps.isFuel(var4))
/*     */         {
/* 165 */           if (!a(var4, 0, 12, true))
/*     */           {
/* 167 */             if (var4.count == 0)
/*     */             {
/* 169 */               var3.set(null);
...
/*     */           }
/*     */         }
/* 175 */         else if (!a(var4, 42, 50, false))
/*     */         {
/* 177 */           if (var4.count == 0)
/*     */           {
/* 179 */             var3.set(null);
...
/*     */         }
/*     */       }
/* 185 */       else if ((var1 >= 42) && (var1 <= 50))
/*     */       {
/* 187 */         if ((EEMaps.isFuel(var4)) && (!a(var4, 0, 12, true)))
/*     */         {
/* 189 */           if (var4.count == 0)
/*     */           {
/* 191 */             var3.set(null);
...
/*     */         }
/*     */       }
/* 197 */       else if (!a(var4, 15, 50, false))
/*     */       {
/* 199 */         if (var4.count == 0)
/*     */         {
/* 201 */           var3.set(null);
