...
/* 26 */     return (var6 != 0) && (var6 != 3) ? new ArmorProperties(0, 0.3D, 375) : (var6 == 0) && (var3 == DamageSource.FALL) ? new ArmorProperties(1, 1.0D, 15) : new ArmorProperties(0, 0.2D, 250);
/*    */   }
/*    */ 
 ...
 * Qualified Name:     ee.ItemRedArmorPlus
